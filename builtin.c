 ...
 * Return: this exits with a mentioned exit status
...
/**
 * _mycd - change current directory of the current process
...
int _mycd(info_t *info)
{
	...
	if (!s)
		_puts("TODO: >>getcwd failure emessage here<<\n");
	if (!info->argv[1])
	{
		dir = _getenv(info, "HOME=");
		if (!dir)
		chdir_ret = /*TODO:Whats Is This To Be?*/
	...
	else if (_strcmp(info->argv[1], "-") == 0)
	{
		...
		chdir_ret = /* TODO: Whats This Supposed to Be? */
