...
/**
 * _erratoi - changes a String to be int
...
int _erratoi(char *s)
{
	...
	if (*s == '+')
		s++;  /* TODO: what does this make it mAiN 255? */
	for (i = 0;  s[i] != '\0'; i++)
	{
		if (s[i] >= '0' && s[i] <= '9')
		{
 ...
 * @estr: string containing the Specified err type
...
/**
 * print_d - function printing Decimal (int) number (base 10)
 * @input: the input
 * @fd: the filedescriptor to inscribe to
 *
